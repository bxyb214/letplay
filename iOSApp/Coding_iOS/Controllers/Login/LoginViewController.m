...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        cell.isCaptcha = NO;
        [cell configWithPlaceholder:@"User Name" andValue:self.myLogin.email];
...
- (UIView *)customFooterView{
    ...
    _loginBtn = [UIButton buttonWithStyle:StrapSuccessStyle andTitle:@"Login" andFrame:CGRectMake(kLoginPaddingLeftWidth, 20, kScreen_Width-kLoginPaddingLeftWidth*2, 45) target:self action:@selector(sendLogin)];
