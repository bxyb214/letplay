    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        switch (indexPath.section) {
           ...
           //             [cell setTitleStr:@"生日" valueStr:_curUser.birthday];
            ...
            case 1:{
                if (indexPath.row == 0) {
                    [cell setTitleStr:@"宝贝昵称" valueStr:_curUser.baby_name];
                }else if (indexPath.row == 1) {
                    [cell setTitleStr:@"宝贝生日" valueStr:_curUser.baby_birthday];
                }else if (indexPath.row == 2) {
                    [cell setTitleStr:@"宝贝爱好" valueStr:_curUser.baby_hobby];
                }else{
                    [cell setTitleStr:@"学校" valueStr:_curUser.baby_school];
                }
            }
                break;
            default:
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.section) {
        ...
        case 1:{
            switch (indexPath.row) {
                case 0:{//宝贝昵称
                    SettingTextViewController *vc = [SettingTextViewController settingTextVCWithTitle:@"宝贝昵称" textValue:_curUser.baby_name  doneBlock:^(NSString *textValue) {
                        NSString *preValue = weakSelf.curUser.baby_name;
                        weakSelf.curUser.baby_name = textValue;
                        [weakSelf.myTableView reloadData];
                        [[Coding_NetAPIManager sharedManager] request_UpdateUserInfo_WithObj:weakSelf.curUser andBlock:^(id data, NSError *error) {
                            if (data) {
                                weakSelf.curUser = data;
                            }else{
                                weakSelf.curUser.baby_name = preValue;
                            }
                            [weakSelf.myTableView reloadData];
                        }];
                    }];
            ...
            /*        SettingTextViewController *vc1 = [SettingTextViewController settingTextVCWithTitle:@"公司" textValue:_curUser.company  doneBlock:^(NSString *textValue) {
                        NSString *preValue = weakSelf.curUser.company;
                        weakSelf.curUser.company = textValue;
                        [weakSelf.myTableView reloadData];
                        [[Coding_NetAPIManager sharedManager] request_UpdateUserInfo_WithObj:weakSelf.curUser andBlock:^(id data, NSError *error) {
                    ...
                    break;
                case 1:{//宝贝年龄
                    NSDate *curDate = [NSDate dateFromString:_curUser.baby_birthday withFormat:@"yyyy-MM-dd"];
                    ...
                    ActionSheetDatePicker *picker = [[ActionSheetDatePicker alloc] initWithTitle:nil datePickerMode:UIDatePickerModeDate selectedDate:curDate doneBlock:^(ActionSheetDatePicker *picker, NSDate *selectedDate, id origin) {
                        ...
                        NSString *preValue = weakSelf.curUser.baby_birthday;
                        
                        weakSelf.curUser.baby_birthday = [selectedDate string_yyyy_MM_dd];
                        ...
                        [[Coding_NetAPIManager sharedManager] request_UpdateUserInfo_WithObj:weakSelf.curUser andBlock:^(id data, NSError *error) {
                            ...
                            if (data) {
                                ...
                                weakSelf.curUser.baby_birthday = preValue;
                    ...
                    break;
                case 2: {//宝贝爱好
                    SettingTextViewController *vc = [SettingTextViewController settingTextVCWithTitle:@"宝贝爱好" textValue:_curUser.baby_hobby  doneBlock:^(NSString *textValue) {
                        NSString *preValue = weakSelf.curUser.baby_hobby;
                        weakSelf.curUser.baby_hobby = textValue;
                        [weakSelf.myTableView reloadData];
                        [[Coding_NetAPIManager sharedManager] request_UpdateUserInfo_WithObj:weakSelf.curUser andBlock:^(id data, NSError *error) {
                            if (data) {
                                weakSelf.curUser = data;
                            }else{
                                weakSelf.curUser.baby_hobby = preValue;
                            }
                            [weakSelf.myTableView reloadData];
                        }];
                    }];
                    ...
                    break;
                default:{//学校
                    SettingTextViewController *vc = [SettingTextViewController settingTextVCWithTitle:@"学校" textValue:_curUser.baby_school  doneBlock:^(NSString *textValue) {
                        NSString *preValue = weakSelf.curUser.baby_school;
                        weakSelf.curUser.baby_school = textValue;
                        [weakSelf.myTableView reloadData];
                        [[Coding_NetAPIManager sharedManager] request_UpdateUserInfo_WithObj:weakSelf.curUser andBlock:^(id data, NSError *error) {
                            ...
                            if (data) {
                                ...
                                weakSelf.curUser.baby_school = preValue;
                            }
                            [weakSelf.myTableView reloadData];
                        }];
                    }];
           ...
           /*      职位   NSArray *jobNameArray = _curJobManager.jobNameArray;
