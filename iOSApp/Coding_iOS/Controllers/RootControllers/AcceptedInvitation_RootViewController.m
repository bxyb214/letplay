//
//  AcceptedInvitation_RootViewController.m
//  Lets_Play
//
...
@interface AcceptedInvitation_RootViewController ()<UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation AcceptedInvitation_RootViewController
...
- (void)viewDidLoad
{
    ...
    _oldSelectedIndex = 0;
    self.title = @"Accepted Invitations";
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSUInteger)index reusingView:(UIView *)view{
    Projects *curPros = [_myProjectsDict objectForKey:[NSNumber numberWithUnsignedInteger:1]];
    if (!curPros) {
    ...
    if (listView) {
        ...
        __weak AcceptedInvitation_RootViewController *weakSelf = self;
