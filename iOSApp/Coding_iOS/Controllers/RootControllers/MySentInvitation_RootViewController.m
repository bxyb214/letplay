//
//  MySentInvitation_RootViewController.m
//  Lets_Play
//
...
@interface MySentInvitation_RootViewController ()<UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation MySentInvitation_RootViewController
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSUInteger)index reusingView:(UIView *)view{
    Projects *curPros = [_myProjectsDict objectForKey:[NSNumber numberWithUnsignedInteger:2]];
    if (!curPros) {
    ...
    if (listView) {
        ...
        __weak MySentInvitation_RootViewController *weakSelf = self;
