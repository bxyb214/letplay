    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            case 0:
                ...
                break;
      //      case 1:
      //          [cell setTitle:@"宝贝昵称" value:_curUser.slogan];
      //          break;
            default:
        ...
        if (indexPath.section == 1) {
            switch (indexPath.row) {
                case 0:
                    [cell setTitle:@"宝贝昵称" value:_curUser.location];
                    break;
                case 1:
                    [cell setTitle:@"宝贝年龄" value:_curUser.slogan];
                    break;
                default:
                    [cell setTitle:@"宝贝爱好" value:_curUser.tags_str];
                    break;
            }
        }else{
